...
exports.resetPasswordInit = email =>
	...
	new Promise((resolve, reject)=> {
		...
		.then(user => {
			...
			const transporter = nodemailer.createTransport('smtps://mike@hunting-cool.com:1mm@g1nation@smtp-relay.gmail.com');

			const mailOptions = {

				from: `"Mike Nedelko" <mike@hunting-cool.com>`,
    			to: email,  
    			subject: 'Reset Password Request ', 
    			html: `Hello ${user.name},

    			     Your reset password token is <b>${random}</b>. 
    			If you are viewing this mail from a Android Device click this <a href="http://mascapone/${random}">link</a>. 
